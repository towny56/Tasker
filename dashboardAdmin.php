                    ...
                    <table class = "tableFill">
                        ...
                        <tbody class = "tableBody">
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    if($result = $connection->query($sql)){
                                        ...
                                        $sumOpenSQL = "SELECT count(*) as tasksOpen FROM tasks WHERE status = 'open'";
                                        $resultOpen = $connection->query($sumOpenSQL);
                                        $rowOpen = $resultOpen->fetch_assoc();

                                        $sumClosedSQL = "SELECT count(*) as tasksClosed FROM tasks WHERE status = 'closed'";
                            ...
                            <tr>
                                <td>
                                    <form></form>
                                    <form class = "formButton" method = "POST" action = "tasksOpenAdmin.php">
                                        <button class = 'Button' type = 'submit'> Open tasks </button>
                                    </form>
                                </td>
                                <td>
                                    <form class = "formButton" method = "POST" action = "tasksClosedAdmin.php">
